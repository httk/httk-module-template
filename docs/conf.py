...
# is verified rather than merely rendered.
...
# AutoAPI cannot resolve imports from the separate httk-core distribution.
...
def generate_example_pages(app):
    """Generate one literal-included documentation page per example script."""
